...
# General params
iteration_id <- "reveal_0051"
initial_seed <- 323451
bg_colour <- "#B8C3CC"
line_colour <- "#7E7F9A"
colour_opts <- c("#CAE7B9", "#F3DE8A", "#EB9486")

# Create data ------------------------------------------------------------------

blobs_combined <- blobs_and_tiles(
  arrangement = "15x15", seed_vec = initial_seed, bg = bg_colour,
  colours = colour_opts, groups_min = 2, groups_max = 15)
